...
import { Kanban, LayoutGrid, ShoppingCart, User, Mail, Phone, Calendar, Shield, Save, ArrowLeft, CheckCircle, Key, BriefcaseBusiness, AlertCircle, Camera, Clock, Boxes } from 'lucide-react';
      ...
      <div className="space-y-6 max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" className="hidden md:inline-flex bg-gray-100 text-gray-700 border-gray-300 hover:bg-gray-200 hover:text-gray-900" onClick={() => navigate('/staff/dashboard')}>
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <p className="text-sm text-gray-600 font-medium">{formData.employeeId}</p>
                  </div>
                </div>
